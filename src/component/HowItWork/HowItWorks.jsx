...
const HowItWorks = () => {
  return (
    <div className="lg:max-w-[1440px] w-full mx-auto">
      ...
      >
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2  gird-cols-1 gap-12 items-center">
          {/* Left Content */}
          <div>
            <CardContent label="how it works" align="start" />

            <h2 className="text-[44px] font-[500] text-[#242424] mt-4 leading-[120%] tracking-[-0.5px] max-w-4xl">
            ...
            {steps.map((step) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-[400] leading-[28px] tracking-normal text-[#333333] text-base mt-[19px]">
                    {step.desc}
                  </p>
                </div>
              </div>
