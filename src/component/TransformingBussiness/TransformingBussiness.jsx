  ...
  return (
    <div className="lg:max-w-[1440px] w-full mx-auto">
      <div className="bg-[#FEFAF6] py-[40px] px-[20px] md:py-[60px] md:px-[80px] lg:py-[80px] lg:px-[120px]">
        ...
        <h2 className="text-[30px] md:text-[44px] font-[500] text-[#242424] mt-4 leading-[120%] mx-auto text-center tracking-[-0.5px] max-w-[312px] md:max-w-xl">
          ...
          <div className="flex flex-col md:flex-row gap-[10px] md:gap-6 w-full">
            {stats.map((item, index) => (
              <div
                ...
                transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:bg-[#ff784e]"
              >
                <h3 className="xxl:text-[57px] lg:text-[50px] text-[54px] font-[500] mb-2 leading-[60px] tracking-normal">
                  {item.value}
                </h3>
